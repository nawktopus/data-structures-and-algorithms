...
const raisedToTheThird = (arr) => {
  const newRaisedToTheThird =[];
  arr.forEach(a => {
    newRaisedToTheThird.push(Math.pow(a, 3));
  });
  return newRaisedToTheThird;
};
...
const addQuestion = (arr) => {
  const newAddQuestion = arr.map(a => {
    return a + '?';
  });
  return newAddQuestion;
};
...
const forEachTwoToThe = (arr) => {
  const newForEachTwoToThe = [];
  arr.forEach(a => {
    newForEachTwoToThe.push(Math.pow(2,a));
  });
  return newForEachTwoToThe;
};
...
const mapTwoToThe = (arr) => {
  const newMapTwoToThe = arr.map(a => {
    return Math.pow(2,a);
  });
  return newMapTwoToThe;
};
