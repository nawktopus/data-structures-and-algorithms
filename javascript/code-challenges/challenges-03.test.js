...
const containsAnd = (arr) => {
  let newContainsAnd = arr.filter((a) => {
    return a = a.includes('and');
  });
  return newContainsAnd;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  return arr.filter((a) =>
    !forbiddenValues.includes(a)
  );

};
// const newNotInFirstArray = [];
  // arr.filter((a) => {
  //   if (a !== forbiddenValues) {
  //     newNotInFirstArray.push(a);
  //   }
  // });
  // return newNotInFirstArray;
/* ------------------------------------------------------------------------------------------------
